...
<div style="background-color: #030303b3; width: 1000px; margin: auto; margin-top: 40px; padding:50px; border-radius: 20px;  text-align: center; -webkit-box-shadow: 0px 0px 24px 7px rgba(0,0,0,0.66); -moz-box-shadow: 0px 0px 24px 7px rgba(0,0,0,0.66);box-shadow: 0px 0px 24px 7px rgba(0,0,0,0.66);">
    <form action="updateProfile.php" method="post"  enctype ="multipart/form-data"  style="display:flex;flex-wrap:wrap;justify-content:space-evenly;height:200px;">
        <input type="text" name="uname" id="uname" class="chngprotxt"  placeholder="Enter your new user name here">
        <input type="password" name="upass" id="upass" class="chngpropsw" placeholder="enter your new password here">
        <button class=" changprobtn btn btn-primary">Save</button>
